...
<form method="POST" action="/tps/event/tambahdptbaru">
    @csrf
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5 class="card-title">Registrasi Data Pemilih Tambahan</h5>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>KK</label>
                                <input type="text" class="form-control @error('kk') is-invalid @enderror" name="kk" placeholder="Nomor Kartu Keluarga" value="{{ old('kk') }}">
                                @error('kk')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-1">
                                    <select class="form-select  @error('jns_dpt') is-invalid @enderror" name="jns_dpt" placeholder="Jenis Kelamin" >
